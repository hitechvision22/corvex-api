                ...
                <table class="content" width="600" border="0" cellspacing="0" cellpadding="0"
                    ...
                    <tr>
                        <td class="body" style="padding: 40px; text-align: left; ">
                           Salut, {{ $chauffeur->name }}
                            <br>
                            <p> le client {{ $client->name }}, vient de confirmer la finalisation de son trajet sur covoiturage express</p>
                            <br>
                            <p>vous recevrez un dépôt pour cette opération</p>
                        </td>
                    </tr>
